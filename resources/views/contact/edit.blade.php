        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <option value="2" @if($contact->age === 2 ) selected @endif>〜19歳</option>>20歳〜29歳</option>
                    <option value="3" @if($contact->age === 3 ) selected @endif>〜19歳</option>>30歳〜39歳</option>
                    <option value="4" @if($contact->age === 4 ) selected @endif>〜19歳</option>>40歳〜49歳</option>
                    <option value="5" @if($contact->age === 5 ) selected @endif>〜19歳</option>>50歳〜59歳</option>                        
                    <option value="6" @if($contact->age === 6 ) selected @endif>〜19歳</option>>60歳〜</option>
                    </select>
                    <br>
                    お問い合わせ内容
